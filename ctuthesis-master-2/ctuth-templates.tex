...
%\rlap{\ctufield[title]{faculty}}
		\begin{tabular}[c]{@{}l@{}}\ctufield[title]{faculty}\\[2pt]\ctufield[title]{department}\end{tabular}\par
		%
		\vspace{8ex plus 1fill}
		%
		% The document type
		{\Large\ctufield[title]{doctype}\par}
		%
		\vspace*{3ex}
		%
...
\ctutemplateset{include.specification}{
	\includepdf[pages=-,scale=0.9]{\tl_use:c{ g_ctuthesis_field_specification-file_tl }}
}
