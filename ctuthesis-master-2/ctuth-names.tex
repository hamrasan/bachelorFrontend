...
\def\ctucaptionsslovak{
	...
	\def\listlistingname{V\'ypisy}
	\def\figurename{Obr\'azky}
	\def\supervisorname{Ved\'uci}
	\def\supervisorspecialistname{Vedu\'ci l--specialista}
	\def\fieldofstudyname{\v Studijn\'y\ program}
	\def\subfieldofstudyname{Zameranie}
	\def\specificationname{Zadanie\ pr\'ace}
...
\seq_gset_from_clist:Nn \g_ctuthesis_months_slovak_seq { janu\'ara, febru\'ara, marca, apr\'i la, m\'aja, j\'una,
	j\'ula, augusta, septembra, okt\'obra, novembra, decembra }

\seq_gset_from_clist:Nn \g_ctuthesis_Months_slovak_seq { Janu\'ar, Febru\'ar, Marec, Apr\'i l, M\'aj, J\'un,
	J\'ul, August, September, Okt\'ober, November, December }
